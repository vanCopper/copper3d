package core.base {
	...
	public class Transform3D extends EventDispatcher {
		...
		protected var _local 		: Matrix3D; 			// 本地transform
		protected var _world 		: Matrix3D; 			// 全局transform
		protected var _invWorld   : Matrix3D; 			// 逆全局矩阵
		protected var _dirty		: Boolean;				// ditry
		protected var _dirtyInv	: Boolean;				// dirty
		...
		{
			App.world.copyFrom(world);
			App.mvp.copyFrom(world);
			App.mvp.append(App.viewProjection);
		}
